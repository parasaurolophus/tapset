 ...
 * {@link SettingsItemListActivity}.
 * </p>
 * 
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link SettingsItemDetailFragment}.
 * </p>
 */
public class SettingsItemDetailActivity extends FragmentActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.write_tag_item:
                ...
                return SettingsItemListActivity.writeTag(this);

            case R.id.share_qr_code_item:

                return SettingsItemListActivity.showQrCode(this);

            case R.id.scan_qr_code_item:

                return SettingsItemListActivity.scanQrCode(this);
            ...
            case android.R.id.home:
                ...
                NavUtils.navigateUpTo(this, new Intent(this,
                        SettingsItemListActivity.class));
                return true;
     ...
     * {@link Intent#getData()} to
     * {@link SettingsItem#updateAllSettings(Context, Uri)} on the assumption
     * that the handler {@link Activity} was launched to read a NFC tag or scan
     * a QR code
     * 
     * @param requestCode
    ...
    /**
     * Prepare this {@link SettingsItemDetailActivity} to be displayed
     * 
